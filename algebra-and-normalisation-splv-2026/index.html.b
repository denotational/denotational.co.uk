...
Modern partial evaluators incorporate equational laws before extracting
a residual program. The hallmark of modern algebra is representation
theorems: characterising a structure such as the set of polynomials as
the universal structure among a class of structures of interest.</p>
...
<p>Part 2: second-order multi-sorted algebra * Motivation * Categories
of contexts: finite product completion * Object-level and meta-level
variables * Axiomatising object-level substitution * Second-order
equations</p>
<ol start="3" type="1">
