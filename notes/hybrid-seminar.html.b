...
<p>To calibrate expectations, if all goes smoothly you’ll be
spending:</p>
<ul>
<li>10-15 minutes ahead of the seminar setting up.</li>
<li>10-15 minutes afterwards editing and tagging the video.</li>
<li>about 1h processing the video and sharing it. (You can do something
else during this time.)</li>
</ul>
<p>I recommend the following:</p>
<ul>
<li>reserve 40 minutes ahead of the seminar to set-up, if something goes
wrong, you’ll thank me for those extra 30 minutes.</li>
<li>if you haven’t done it before, do a test run a couple of days,
preferably a week, ahead of the seminar. Try to mimic the exact set-up
on the day, including the same room. The goal is encounter as many
issues as you can with a couple of days to spare so you can do something
about it.</li>
<li>reserve around 1h for editting.</li>
<li>having separate in-person and on-line chairs to the session.
(on-line chair monitors the chat, flags issues, takes questions,
etc.)</li>
</ul>
...
<p>(I do not receive commission from Jabra for this
recommendation.)</p></li>
...
<p>Set-up for the speaker:</p>
<ul>
<li><p>connects the Jabra Speak to their laptop</p></li>
<li><p>logs into zoom room, sharing video and using Jabra Speak as mic
and speakers</p></li>
<li><p>uses laptop camera, if they want. (It is actually not necessary
to show their face, although it sometimes helps participants, especially
to notice something has gone wrong and flag it.)</p></li>
<li><p>uses mouse to point at the slides. This may work better even for
in-person participants, e.g., if there are multiple screens to look
at.</p></li>
...
to participate.</p></li>
<li><p>Check with a remote participant that they can hear the room, and
ask them to unmute and check your own room speakers. Do it 5-10 minutes
before the talk starts.</p></li>
</ul>
