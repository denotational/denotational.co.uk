...
Danel Ahman, Ohad Kammar and Rasmus Ejlers Møgelberg. <BR><BR> Appears
in the <a href="">41st Annual Symposium on Logic in Computer Science
(LICS 2026, to appear)</a>, 2026, <a
href="https://doi.org/10.4230/LIPIcs.LICS.2026.63">DOI:
10.4230/LIPIcs.LICS.2026.63</a>.</li>
</ul>
<blockquote>
...
algebraic theories</a>
</h4>
Ohad Kammar, Jack Liell-Cock, Sam Lindley, Cristina Matache, and Sam
Staton. <BR><BR> Appears in the <a href="">53rd ACM SIGPLAN Symposium on
Principles of Programming Languages (POPL 2026), Proceedings of the ACM
on Programming Languages (PACMPL), POPL 2026 (to appear)</a>, 2026, <a
href="https://doi.org/10.1145/3776706">DOI: 10.1145/3776706</a>.</li>
</ul>
<blockquote>
<p>“We use the theory of algebraic effects to give a complete equational
axiomatization for dynamic threads. Our method is based on parameterized
algebraic theories, which give a concrete syntax for strong monads on
functor categories, and are a convenient framework for names and
binding. Our programs are built from the key primitives ‘fork’ and
‘wait’. ‘Fork’ creates a child thread and passes its name (thread ID) to
the parent thread. ‘Wait’ allows us to wait for given child threads to
finish. We provide a parameterized algebraic theory built from fork and
wait, together with basic atomic actions and laws such as associativity
of ‘fork’. Our equational axiomatization is complete in two senses.
First, for closed expressions, it completely captures equality of
labelled posets (pomsets), an established model of concurrency: model
complete. Second, any two open expressions are provably equal if they
are equal under all closing substitutions: syntactically complete. The
benefit of algebraic effects is that the semantic analysis can focus on
the algebraic operations of fork and wait. We then extend the analysis
to a simple concurrent programming language by giving operational and
denotational semantics. The denotational semantics is built using the
methods of parameterized algebraic theories and we show that it is
sound, adequate, and fully abstract at first order for labelled-poset
observations.”</p>
</blockquote>
<ul>
<li><h4>
...
href="https://icfp25.sigplan.org/details/icfp-2025-papers/2/Frex-dependently-typed-algebraic-simplification">30th
ACM SIGPLAN International Conference on Functional Programming.</a>,
2025, <a href="https://doi.org/10.1145/3747506">DOI:
10.1145/3747506</a>.</li>
</ul>
<blockquote>
...
Marcelo Fiore, Ohad Kammar, Georg Moser, and Sam Staton. <BR><BR>
Appears in the <a href="https://arxiv.org/abs/2511.03946">Proceedings of
the 41st Conference on the Matheamtical Foundations of Programming
Semantics</a>, 2025, <a
href="https://arxiv.org/abs/2511.03946">arXiv:2511.03946</a>, <a
href="https://doi.org/10.46298/entics.proceedings.mfps41">DOI:
10.46298/entics.proceedings.mfps41</a>.</li>
</ul>
<blockquote>
...
Talk given at the <a href="https://fiorefest.gitlab.io/home/">Workshop
in Celebration of Marcelo Fiore’s 60th Birthday (FioreFest)</a>,
University of Cambridge, 03 July, 2026.</li>
</ul>
<blockquote>
<p>We propose abstractions for exploiting symmetries in programming and
reasoning, typically employed using the mathematical proof principle
`without-loss-of-generality’. We propose a single principle for removing
symmetric cases and comprising of three components. The first component
explicates group actions on the input type/premise and output
type/conclusion. The second component explicates the choice of group
element for each input that makes it canonical—its canonising symmetry.
The third component provides the program/proof on canonical inputs,
after eliminating the symmetric cases—the core function of the
program/proof. Our proposed principle combines the three by canonising
the input, employing the core function, and applying the inverse
symmetry. In this talk I will cover the mathematical foundations for
symmetric programming and reasoning, and how I used what I learned from
Marcelo about monoids with algebraic structure to eliminate some
performance bottlenecks in symmetry-exploiting code. Based on joint work
with Matija Pretnar.</p>
</blockquote>
<P/>
<ul>
<li><h4>
<a href="talks/plug26-symmetric-programming.pdf">Mathematical
foundations for symmetric programming</a>
</h4>
Talk given at the <a
href="https://samoa.dcs.gla.ac.uk/events/talk/20667">Shameless PLUG
Seminar</a>, University of Glasgow, 27 May, 2026.</li>
</ul>
<blockquote>
<p>Joint work with Matija Pretnar. We propose abstractions for
exploiting symmetries in programming and reasoning based on the
mathematical proof principle ‘without-loss-of-generality’ (wlog). We
decompose such arguments into three components. The first component
makes the symmetry explicit by defining appropriate groups and their
action on the input/assumptions and output/conclusions. The second
component explicates how to canonise the input, by choosing appropriate
symmetries for each input. The third component is a core function/proof
that transforms canonical inputs into outputs. The proposed wlog
construct combines these components: given an input, calculate its
canonising symmetry, use the symmetry to canonise the input, apply the
core function to the canonical input, and apply the inverse symmetry to
the output. Here we develop the mathematical foundations for these
abstractions. We illustrate the approach on running examples:
sliding-tile merges in 2048, binary-tree insertion, and Schur’s
inequality as a mathematical instance of WLOG. We extend the framework
to algebraic datatypes using initial algebra semantics, showing how a
G-symmetry strength on a functor lifts group actions to inductive types
and that the unique fold into an equivariant algebra is itself
equivariant, allowing us to avoid using general recursion to define a
symmetric version of tree insertion. Finally, we develop the theory of
equivariant canonisers and explore the cases when the WLOG construction
is guaranteed to produce an equivariant function.</p>
</blockquote>
<P/>
<ul>
<li><h4>
<a href="talks/algebra-and-normalisation-triple2026.pdf">Algebra and
normalisation</a>
</h4>
Talk given at the <a href="https://typesig.pl/triple2026/">Theory,
Related Interdisciplinary &amp; Programming Languages at Edinburgh
(TRIPLE)</a>, 29 March, 2026.</li>
</ul>
<blockquote>
<p>Normalisation concerns specifying a representative in each
equivalence class. It manifests whenever we want to guarantee robustness
...
code using the equivalence it normalises by. The hallmark of modern
algebra is representation theorems: characterising a structure such as
the set of polynomials as the universal structure among a class of
structures of interest. In this talk, I will relate normalisation to
modern algebra. I will start with algebraic simplification through
familiar algebraic structures. Time permitting, I will turn to
normalisation of program fragments through the more advanced
second-order algebraic structures.</p>
</blockquote>
<P/>
<ul>
<li><h4>
